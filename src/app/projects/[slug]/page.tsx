...
//                           <div
//                             className="
//               group relative rounded-[28px] border border-white/10 bg-[#111]
//               p-3 sm:p-4
//               transition-transform duration-500
//               [transform:rotateX(6deg)]
//               hover:[transform:rotateX(0deg)_translateY(-4px)]
//             "
//                             style={{
...
//                                   <div
//                                     className="
//                       mx-auto flex h-10 max-w-[720px] items-center
//                       rounded-full border border-white/10 bg-white/6 px-4
//                       text-sm font-semibold text-white/90 shadow-inner sm:text-base
//                     "
//                                   >
//                                     {project.liveUrl
//                                       ? new URL(
...
//                                   <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(115deg,rgba(255,255,255,0.18)_0%,rgba(255,255,255,0.06)_18%,rgba(255,255,255,0)_36%)] opacity-80" />
